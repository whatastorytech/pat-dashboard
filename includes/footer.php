<!-- Footer -->
	...
	<script src="admin_assets/vendors/bower_components/moment/min/moment.min.js"></script>
	<script src="admin_assets/vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js"></script>
	<script src="admin_assets/dist/js/simpleweather-data.js"></script>
	
	<!-- Progressbar Animation JavaScript -->
	<script src="admin_assets/vendors/bower_components/waypoints/lib/jquery.waypoints.min.js"></script>
	<script src="admin_assets/vendors/bower_components/jquery.counterup/jquery.counterup.min.js"></script>
	...
	<!-- Owl JavaScript -->
	<script src="admin_assets/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js"></script>
	
	<!-- Toast JavaScript -->
	<script src="admin_assets/vendors/bower_components/jquery-toast-plugin/dist/jquery.toast.min.js"></script>
