				...
				<div class="main-contents">
					<div class="tab-contents mytrees">
						<div class="title-block">
							<h2>Gift Trees</h2>
							<div class="link">
								<a href="index.php" class="bordered-btn">Gift a Tree</a>
							</div>
						</div>
						<div class="tab">
					<?php if($query->rowCount() > 0)
				    {
						foreach($results as $result)
							...
							<div class="tree-block">
								...
								<p class="howmany">Gifted <?php echo $result->count;?> Trees</p>
								...
								<a href="gift_treelist.php?tree_category=<?php echo $result->tree_category_id;?>" class="showall">Show all trees</a>
							</div>
